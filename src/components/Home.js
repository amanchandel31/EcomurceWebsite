...
import {addToCart} from "../redux/fetures/cartSlice.js"
...
const Home = () => {
  ...
  return (
    ...
    <section className='iteam_section mt-4 container'>
       <h2 className='px-4' style={{fontWeight:400}}>Resturents in Uttar pradesh Open now</h2>
       <div className='row mt-2 d-flex justify-content-around align-items-center'>
        {
          ...
          <Card.Img className='cd' src={element.imgdata}/>
